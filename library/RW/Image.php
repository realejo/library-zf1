...
class RW_Image
{
     ...
     * Mime types válidos
     */
    protected array $_fileTypes = ['image/gif', 'image/jpeg', 'image/png'];

    /**
     * Compressão padrão das imagens
     */
    protected array $_imageQuality = ['png' => 9, 'jpeg' => 100, 'gif' => 100];
    ...
    /**
     * Carrega a imagem ao criar a classe
     *
     ...
     *
     * @param string|null $file Endereço do arquivo para salvar a imagem
     * @param bool $close Fecha o arquivo ou mantem na memória
     * @return bool
     */
    public function save(string $file = null, bool $close = false)
    {
     ...
     * @param bool $crop idica se a imagem deve se cortada para o tamanho
     * @param bool $force aumenta a imagem caso ela seja menor
     *
     * @return bool
     */
    public function resize(int $w, int $h, bool $crop = false, bool $force = false): bool
    {
        ...
        if ($crop) {
            ...
            // Faz o crop
            imagecopyresampled($tmp, $this->_image, 0, 0, (int)$x, (int)$y, $w, $h, $w, $h);
