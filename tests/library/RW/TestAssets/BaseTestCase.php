...
class BaseTestCase extends TestCase
{
    ...
    function testBoostrap(): void
    {
        $this->assertTrue(true, 'Bootstrap OK');
    }

    /**
     * @return Zend_Db_Adapter_Abstract|Zend_Db_Adapter_Mysqli
     */
    public function getAdapter(): Zend_Db_Adapter_Mysqli
    {
     ...
     * @return self
     */
    public function setApplicationConstants(): self
    {
